...
#'   school year is year '2024'. Valid values are 2015-2024.
...
#'   district_name, campus_name, and enrollment counts by demographic.
#'   Tidy format pivots these counts into subgroup column.
#' @export
#' @examples
#' \dontrun{
