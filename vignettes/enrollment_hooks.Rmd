...
# Load bundled data for CI builds (avoids network dependency)
cache_file <- system.file("extdata", "vignette_enr_data.rds", package = "alschooldata")
if (file.exists(cache_file) && nzchar(cache_file)) {
  enr <- readRDS(cache_file)
}
```
