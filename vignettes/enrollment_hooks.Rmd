...
# Set eval=FALSE during CI/R CMD check to avoid network calls
# Vignette will still render locally with eval=TRUE
...
This vignette explores Alabama's public school enrollment data, surfacing key trends and demographic patterns across 11 years of data (2015-2025).
