...
**10 years of enrollment data (2015-2024).** Alabama's public schools serve over 730,000 students across 140+ systems. This package lets you explore:
...
![COVID impact by grade](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/covid-chart-1.png)
...
- Small cell suppression: Counts under 10 may be suppressed in some reports
- Historical data (pre-2015) is not available in the current downloadable format
