...
**5 years of enrollment data (2021-2025).** Alabama's public schools serve over 734,000 students across 140+ systems. The state added 8,400 students since 2021 while Hispanic enrollment surged 33% and the Black Belt hemorrhaged students. This package lets you explore:

- Statewide enrollment trends and post-pandemic growth
...
- Multi-year comparisons revealing urban-suburban shifts and rural decline
...
#> 1     2021     726348     NA         NA
#> 2     2022     729571   3223       0.44
#> 3     2023     731894   2323       0.32
#> 4     2024     733156   1262       0.17
#> 5     2025     734817   1661       0.23
```

![Statewide trend](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/statewide-chart-1.png)
...
#> 1      Mobile County      49823
#> 2      Shelby County      34892
#> 3   Jefferson County      34217
#> 4     Baldwin County      33412
#> 5  Montgomery County      26914
#> 6    Huntsville City      24831
#> 7     Madison County      24273
#> 8    Birmingham City      19417
#> 9  Tuscaloosa County      18934
#> 10     Morgan County      15273
```
...
![Hispanic trend](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/hispanic-chart-1.png)
...
![White enrollment trend](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/white-chart-1.png)
...
#> 1       white     341278        46.4
#> 2       black     237491        32.3
#> 3    hispanic      58934         8.0
#> 4 multiracial      19842         2.7
#> 5       asian      11247         1.5
```
...
![EL trend](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/el-chart-1.png)
...
![Econ disadv trend](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/econ-chart-1.png)
...
![Special ed trend](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/sped-chart-1.png)
...
![Birmingham suburbs](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/suburb-chart-1.png)
...
![Huntsville growth](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/huntsville-chart-1.png)
...
#>   <chr>          <dbl> <dbl>      <dbl>
#> 1 Greene County   1042   823      -21.0
#> 2 Perry County    1347  1089      -19.2
#> 3 Wilcox County   1184   978      -17.4
#> 4 Lowndes County  1573  1312      -16.6
#> 5 Dallas County   3847  3284      -14.6
#> 6 Sumter County   1218  1047      -14.0
```

![Black Belt decline](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/black-belt-chart-1.png)

---

### 12. 9th grade is the largest class by far

With 62,572 students, 9th grade is nearly 15% larger than 8th grade. This "9th grade bulge" reflects course failure, grade retention, and the transition shock from middle to high school.
...
![Grade distribution](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/grade-chart-1.png)
...
#> 1      2021 Baldwin County      31284
#> 2      2021  Mobile County      52184
#> 3      2022 Baldwin County      31893
#> 4      2022  Mobile County      51473
#> 5      2023 Baldwin County      32417
#> 6      2023  Mobile County      50912
#> 7      2024 Baldwin County      32918
#> 8      2024  Mobile County      50347
#> 9      2025 Baldwin County      33412
#> 10     2025  Mobile County      49823
```

![Mobile vs Baldwin](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/mobile-baldwin-chart-1.png)
...
#> 3   Piedmont City        467
#> 4     Lanett City        489
#> 5  Fairfield City        523
#> 6    Tarrant City        568
#> 7  Chickasaw City        612
#> 8   Greene County        823
#> 9  Sheffield City        847
#> 10   Attalla City        917
```

![Smallest districts](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/smallest-chart-1.png)
...
![Grade band trends](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/grade-band-chart-1.png)
...
Alabama State Department of Education Federal Report Card Student Demographics: [reportcard.alsde.edu](https://reportcard.alsde.edu/)

### Available Years

2021-2025 (5 years of complete enrollment data)

### What's Included

- **Levels:** State, system/district (~140), campus/school (~1,600)
- **Demographics:** White, Black, Hispanic, Asian, American Indian, Pacific Islander, Two or More Races
- **Special populations:** Economically disadvantaged, English learners (LEP), Students with disabilities (special education)
- **Gender:** Male, Female
...
- Small cell suppression: Counts under 10 may be suppressed
- Entity flags: `is_state`, `is_district`, `is_campus`
- No `is_charter` flag is defined for Alabama

### Standard Tidy Column Names

- **Subgroups:** `total_enrollment`, `white`, `black`, `hispanic`, `asian`, `native_american`, `pacific_islander`, `multiracial`, `male`, `female`, `econ_disadv`, `lep`, `special_ed`
- **Grade levels:** `PK`, `K`, `01`-`12`, `TOTAL`
...
A simple, consistent interface for accessing state-published school data in Python and R. This project originated with [njschooldata](https://github.com/almartin82/njschooldata) for New Jersey and has expanded to cover all 50 states.
