...
**NOT in tidy enrollment:** Gender subgroups (male/female) are included.
Special populations (econ_disadv, lep, special_ed) are included when
present in the ALSDE source data.
...
0 errors, 0 warnings - \[ \] `pytest tests/test_pyalschooldata.py` — all
tests pass - \[ \]
...
**Data Source:** Alabama State Department of Education (ALSDE) Alabama
Achieves - URL: <https://www.alabamaachieves.org/assessment/> -
Assessment: Alabama Comprehensive Assessment Program (ACAP) Reading -
Proficiency Definition: At or above grade level

**Assessment Data Limitations:** - Only Reading/ELA assessments are
available in Excel format - Math and Science assessments are not
available as downloadable data files - Only grades 2-3 are included
...
- Limited grade coverage: Only grades 2-3 (early literacy assessment
  grades)
...
The test suite verifies: 1. All years fetchable: 2021-2025 all download
and process successfully 2. All subgroups present: total_enrollment,
white, black, hispanic, asian, native_american, pacific_islander,
multiracial 3. All grade levels present: TOTAL, PK, K, 01-12 4. Data
quality: No negative enrollment counts, no Inf/NaN percentages 5.
Aggregation: State totals match sum of districts 6. Fidelity: tidy=TRUE
preserves exact raw counts from wide format

### Assessment Tests

The test suite verifies: 1. All years fetchable: 2022-2025 all download
and process successfully 2. Proficiency rates between 0 and 1 (or
