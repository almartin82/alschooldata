...
**11 years of enrollment data (2015-2025).** 730,000 students across
140+ school systems. Here are ten stories hiding in the numbers:

------------------------------------------------------------------------

### 1. Alabama’s enrollment is holding steady

Unlike many states seeing sharp declines, Alabama’s public school
enrollment has remained relatively stable around 730,000 students, with
...
grades, especially kindergarten, which saw significant drops in 2021.
...
level](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/covid-chart-1.png)

COVID impact by grade level
...
been losing students while suburban systems grow.
...
![Alabama’s 10 largest school
systems](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/top-districts-chart-1.png)

Alabama’s 10 largest school systems
...
![Hispanic enrollment
growth](https://almartin82.github.io/alschooldata/articles/enrollment_hooks_files/figure-html/hispanic-chart-1.png)
...
largest school systems in the Southeast and operates like a mini-state.
