...
Directory. Data includes school and district contact information
including administrator names, physical addresses, phone numbers,
websites, grade ranges, and superintendent names.
...
Directory data is a point-in-time snapshot (not year-specific)
reflecting the current state of the ALSDE Education Directory.
